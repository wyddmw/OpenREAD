...
class LingoQAPreprocess(MessagesPreprocessor):
    def preprocess(self, row: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        answer = row['messages'][1]['value']
        question = row['messages'][0]['value']
...
register_dataset(
    DatasetMeta(
        dataset_path='/home/users/ntu/keqi001/scratch/zsy_projects/projects/VLMs/WiseAD_qwen3_vl/ms-swift/train_eval_ana/658_sampled_part1_part2_20000_avg658_sampled500.json',
        preprocess_func=LingoQAPreprocess(),
        tags=['qa', 'vision', 'grpo']))